...
const DoctorRow = (props) => {
    ...
    return <>
        <tr data-upin={props.doctor.upin}
            className="rowDoctor"
            style={props.doctor.available ? {} : {
                textDecoration: "line-through", fontStyle: "italic", background: "rgb(229 234 236)"
            }}
        >
            ...
            <td>
                <button
                    className={props.doctor.available ? "button_unavailable" : "button_available"}
                    onClick={() => onClickButton(props.doctor)}>
